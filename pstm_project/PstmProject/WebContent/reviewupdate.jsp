...
<body>
	...
	<div class="content" id="app" style="">
		...
		<div class="review_contents wrapper">
			...
			<form action="reviewupdateres.jsp" method="post">
			<input type="hidden" name="reviewid" value="<%=dto.getReviewid()%>">
					<table border="1">
						<tr>
							<th>제목</th>
							<td><input type="text" name="reviewtitle" value="<%=dto.getReviewtitle() %>" readonly="readonly"/>
							</td>
					...
					<form method="post">
					<textarea name="summernote" id="summernote" class="summernote" style="margin: 0;"><%=dto.getReviewcontent() %>
					...
					<table style="float: right;">
						<tr>
							...
							<input type="button" value="취소" onclick="location.href='reviewlist.jsp?reviewid=<%=dto.getReviewid() %>'" /> 
