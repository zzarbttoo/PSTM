				...
				<form action="reviewupdateres.jsp" method="post">
					...
					<table border="1">
						<tr>
							...
							<td><input type="text" name="reviewtitle"
								value="<%=dto.getReviewtitle()%>" readonly="readonly" /></td>
					...
					<form method="post">
						<textarea name="summernote" id="summernote" class="summernote"
							style="margin: 0;"><%=dto.getReviewcontent()%></textarea>
					</form>
					<table style="float: right;">
						<tr>
							<td colspan="2" align="right"><input type="button"
								value="취소"
								onclick="location.href='reviewlist.jsp?reviewid=<%=dto.getReviewid()%>'" />
